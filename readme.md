...
- Added a property `World.frictionGravity`, which will be used when computing the friction on two colliding bodies. The value defaults to `World.gravity` and allows for enabling friction in zero gravity. This addresses issue [#224](https://github.com/schteppe/cannon.js/issues/224) and follows the [pattern established for p2.js](https://github.com/schteppe/p2.js/blob/master/src/world/World.js#L88-L92).
